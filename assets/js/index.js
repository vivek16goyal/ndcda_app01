    ...
    try {
        $('#txtOrderParty').autocomplete({
            ...
            source: function (request, response) {
                ...
                $.ajax({
                    url: localStorage.getItem("APIURL") + "/Order/GetParty1",
...
function CheckPartyRegistration(val) {
    ...
    var Code = localStorage.getItem("PCode");
    if (clientCode == null || clientCode == "") {
        ...
        var APIURL = localStorage.getItem("APIURL");
        var url = APIURL + "/Values/checkparty1?PtCode=" + clientCode;
        try {
            $.ajax({
                url: url,
                type: "GET",
                        ...
                        if (APPType == "$") {
                            ...
                            if (data.split('|')[0] == null || data.split('|')[0] == "") {
                                ...
                                if (data.indexOf("$") == 0) {
                                    ...
                                    //localStorage.setItem("APIURL", WebSerUrl);
...
function PingTiaService(val) {
    ...
    var APIURL = localStorage.getItem("APIURL");
    APIURL = APIURL + "/Values/Ping1?PtCode=" + localStorage.getItem("ClientCode");
    $.ajax({
        url: APIURL,
        type: "GET",
        dataType: "json",
...
$(function () {
    try {
        $('#itm-srch').autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: localStorage.getItem("APIURL") + "/Product/GetItemConsumerNDCDA",
...
function get_make(make) {
    var WebSerUrl = localStorage.getItem("APIURL");
    url = WebSerUrl + "/Product/getmaking";
    debugger;
    $.ajax({
        url: url,
        // url: WebSerUrl, 
...
function get_company(CCODE) {
    var WebSerUrl = localStorage.getItem("APIURL");
    url = WebSerUrl + "/Product/getcompany?CCODE=" + CCODE;
    $.ajax({
        url: url,
        // url: WebSerUrl,
        type: "GET",
...
function getGnName1(item_pt) {
    var WebSerUrl = localStorage.getItem("APIURL");
    url = WebSerUrl + "/Product/getGnName1?Icode=" + item_pt;
    $.ajax({
        url: url,
        // url: WebSerUrl,
        type: "GET",
...
function GET_PARTYCODE(item_pt)
{
    //GBCServicePath 
    var WebSerUrl = localStorage.getItem("APIURL");
...
function SubstitudeItemList() {
    var gname = $("#lblContent").text();
    if (gname == "-------") {
        loadmsg = "genric is not Defined.....";
    }
    else {
        $("#gnameS").text($("#lblContent").text());
        loadmsg = "Loading Item List...";
        $(".show-page-loading-msg").click();
        var WebSerUrl = localStorage.getItem("APIURL") + "/Product/AlternateIMndcda";
        $.ajax({
            url: WebSerUrl,
            type: "GET",
            dataType: "json",
            ...
            success: function (data) {
                try {
                    ...
                    for (var i = 0; i < itm.length; i++) {
                        var data1 = itm[i];
                        var a = '"';
                        $("#Substitude_Grid").append("<li onclick= " + a + "SetDataFromSubstitude('" + data1.Icode + "','" + data1.Iname + "','" + data1.PACKING + "','" + data1.CCODE + "','" + data1.MAKE + "');" + a + " class='ui-first-child ui-last-child' id=" + i + ">" +
...
function GetDataFromRegCode() {
    ...
    $.ajax({
        ...
        url: WebSerUrl + "/Values/geTCode1?code=" + $("#txt-clientCode").val(),
        type: "GET",
        dataType: "json",
        cache: false,
        success: function (data) {
